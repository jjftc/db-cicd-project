...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8405509724392055)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8405805683392056)
,p_plug_template_id=>wwv_flow_imp.id(8405509724392055)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8406122082392056)
,p_plug_template_id=>wwv_flow_imp.id(8405509724392055)
,p_name=>'Sub Regions'
