...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8376810043392022)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8377199821392022)
,p_plug_template_id=>wwv_flow_imp.id(8376810043392022)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8377440613392022)
,p_plug_template_id=>wwv_flow_imp.id(8376810043392022)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8377793269392023)
,p_plug_template_id=>wwv_flow_imp.id(8376810043392022)
,p_name=>'Sub Regions'
