...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8439998218392090)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8440240964392091)
,p_plug_template_id=>wwv_flow_imp.id(8439998218392090)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8440519069392091)
,p_plug_template_id=>wwv_flow_imp.id(8439998218392090)
,p_name=>'Tabs'
