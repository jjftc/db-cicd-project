...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8427677227392078)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8427985297392078)
,p_plug_template_id=>wwv_flow_imp.id(8427677227392078)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8428253592392078)
,p_plug_template_id=>wwv_flow_imp.id(8427677227392078)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8428512922392079)
,p_plug_template_id=>wwv_flow_imp.id(8427677227392078)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8428860821392079)
,p_plug_template_id=>wwv_flow_imp.id(8427677227392078)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8429121724392079)
,p_plug_template_id=>wwv_flow_imp.id(8427677227392078)
,p_name=>'Sub Regions'
