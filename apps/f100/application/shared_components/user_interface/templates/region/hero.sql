...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8402328188392052)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8402670366392052)
,p_plug_template_id=>wwv_flow_imp.id(8402328188392052)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8402976626392053)
,p_plug_template_id=>wwv_flow_imp.id(8402328188392052)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8403220029392053)
,p_plug_template_id=>wwv_flow_imp.id(8402328188392052)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8403593668392053)
,p_plug_template_id=>wwv_flow_imp.id(8402328188392052)
,p_name=>'Sub Regions'
