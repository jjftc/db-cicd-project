...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8447384081392098)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8447651582392098)
,p_plug_template_id=>wwv_flow_imp.id(8447384081392098)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8447997264392098)
,p_plug_template_id=>wwv_flow_imp.id(8447384081392098)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8448294978392098)
,p_plug_template_id=>wwv_flow_imp.id(8447384081392098)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8448572531392099)
,p_plug_template_id=>wwv_flow_imp.id(8447384081392098)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8448816709392099)
,p_plug_template_id=>wwv_flow_imp.id(8447384081392098)
